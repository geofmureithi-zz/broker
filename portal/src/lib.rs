#![doc(html_root_url = "https://docs.rs/portal/0.2.0")]
#![deny(missing_docs)]
...
//!
//! Thanks to its [`Filter`][Filter] system, portal provides these out of the box:
//!
...
//! ## Filters
//!
//! The main concept in portal is the [`Filter`][Filter], which allows composition
//! to describe various endpoints in your web service. Besides this powerful
//! trait, portal comes with several built in [filters](filters/index.html), which
...
//! ## Testing
//!
//! Testing your web services easily is extremely important, and portal provides
