...
//! use portal::Filter;
//!
//! let with_server = portal::reply::with::header("server", "portal");
//!
...
/// let route = portal::any()
///     .map(portal::reply)
///     .with(portal::reply::with::header("foo", "bar"));
/// ```
...
/// let route = portal::any()
///     .map(portal::reply)
///     .with(portal::reply::with::headers(headers));
/// ```
...
/// use portal::Filter;
///
/// // Set `server: portal` if not already set.
/// let route = portal::any()
///     .map(portal::reply)
///     .with(portal::reply::with::default_header("server", "portal"));
/// ```
