...
/// let content_length = portal::header::<u64>("content-length");
///
/// // Parse `host: 127.0.0.1:8080` as a `SocketAddr
/// let local_host = portal::header::<SocketAddr>("host");
///
/// // Parse `foo: bar` into a `String`
/// let foo = portal::header::<String>("foo");
/// ```
...
/// let opt_auth = portal::header::optional::<String>("authorization");
/// ```
pub fn optional<T>(
    name: &'static str,
...
/// let must_dnt = portal::header::exact("dnt", "1");
/// ```
pub fn exact(
    name: &'static str,
    value: &'static str,
...
/// let keep_alive = portal::header::exact("connection", "keep-alive");
/// ```
...
///
/// ```
/// use portal::{Filter, http::HeaderMap};
///
/// let headers = portal::header::headers_cloned()
