...
/// let upload = portal::body::content_length_limit(4096)
///     .and(portal::body::aggregate());
/// ```
...
///
/// ```
/// use portal::{Buf, Filter};
///
/// let route = portal::body::content_length_limit(1024 * 32)
///     .and(portal::body::bytes())
