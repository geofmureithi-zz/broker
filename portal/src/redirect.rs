...
///
/// let route = portal::path("v1")
///     .map(|| {
///         portal::redirect(Uri::from_static("/v2"))
///     });
/// ```
...
/// let route = portal::path("v1")
///     .map(|| {
///         portal::redirect::temporary(Uri::from_static("/v2"))
///     });
/// ```
...
mod sealed {
    ...
    // arguments could be accepted, like maybe just `portal::redirect("/v2")`.
